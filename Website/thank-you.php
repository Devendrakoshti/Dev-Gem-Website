<?php
$page_title = "Request Received | We'll Be in Touch Soon!";
$page_desc = "Thank you for contacting Gem Gujarat. Our team will be in touch with you shortly to discuss your needs.";
$canonical_url = "https://www.gemgujarat.in/thank-you.php";
$preload_image = "https://www.gemgujarat.in/images/thank-you.webp";
$og_image = "https://www.gemgujarat.in/images/thank-you.webp";
$og_width = "1280";
$og_height = "1162";
...
<section class="container py-5">
  <div class="d-flex justify-content-center align-items-center flex-column thank-you-page text-center">
    <img loading="lazy" src="https://www.gemgujarat.in/images/thank-you.webp" alt="Thank You Logo" title="Thank You Logo" class="img-fluid" width="450" height="408">
    <h1 class="mt-5 mb-3">Thank You</h1>
    <p class="fs-3 lh-sm mb-4">Thank you for reaching out to Gem Gujarat! We appreciate your interest. <br> Our team will contact you within one business day. </p>
    <a title="Return to GEM Gujarat Home Page" class="btn-primary" href="https://www.gemgujarat.in/"> Back to home page <span>
