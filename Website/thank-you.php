...
<head>
   ...
   <title>Request Received | We'll Be in Touch Soon!</title>
   <meta name="description" content="Thank you for contacting Gem Gujarat. Our team will be in touch with you shortly to discuss your needs.">
   <link rel="canonical" href="https://www.teslaoutsourcingservices.com/thank-you.php">
      <!-- End Google Tag Manager -->
<?php include 'includes/header.php';?>
<!-- thank you start  -->
   <section class="container py-5">
       <div class="d-flex justify-content-center align-items-center flex-column thank-you-page text-center">
         <img loading="lazy"src="images/thank-you.webp" alt="Thank You Logo" title="Thank You Logo" class="img-fluid" width="450" height="408">
