  ...
  <div class="container">
    ...
    <div class="d-block w-100">
      ...
      <div class="row g-4 fs-16">
        ...
        <!-- <div class="col-xl-3 col-md-6"><div class="h-100 rounded-5 border bg-white shadow p-4"><img src="images/icons/learning.svg" alt="Profile Setup" title="Profile Setup" class="img-fluid mb-3" width="40" height="40"><h4 class="fw-medium mb-2 fs-5 text-red">Training & Support</h4><p class="mb-0">A quick, friendly orientation on how to manage your dashboard and bid on tenders.</p></div></div> -->
      </div>
    </div>
  </div>
</section>
