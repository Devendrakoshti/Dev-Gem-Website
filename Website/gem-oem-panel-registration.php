              ...
              <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    <p> To gain exclusive control over your brand’s dashboard and catalogue authority, our specialized GeM Registration for Manufacturer service guides you through the process of achieving OEM status, allowing you to manage product listings and authorize resellers for government procurement. </p>
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    <p>To secure your official OEM status, we provide end-to-end guidance for the RITES Vendor Assessment Process, a mandatory audit that verifies your manufacturing capacity, quality control systems, and financial stability to ensure portal compliance. </p>
                  </div>
                </div>
              </div>
              <div class="accordion-item">
