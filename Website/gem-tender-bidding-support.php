...
<html lang="en">
  <head>
    ...
    <!-- header end -->
    <!-- banner start  -->
    <div class="service-banner w-100 gem-gujarat-tender-bidding-support-banner">
      <div class="container">
        <div class="row">
          <div class="col-lg-10">
                ...
                <div class="accordion" id="accordionExample">
                  ...
                  <div class="accordion-item">
                    ...
                    <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        <p>
                          No. We are a GeM Tender Consultant India service, supporting entrepreneurs and small businesses nationwide. We help you find and bid on relevant tenders across all Central and State government departments listed on the GeM portal in India.
                        </p>
                      </div>
                    </div>
                  </div>
