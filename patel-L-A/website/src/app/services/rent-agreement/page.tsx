...
const metaTitle = "Rent Agreement | PATEL LEGAL ADVISORS";
const metaDescription ="We take pride in offering comprehensive rent agreements that establish clear and harmonious relationships between landlords and tenants. Our meticulous agreements are designed to ensure transparency, legal compliance, and a positive rental experience for all parties involved.";

const title = "Rent Agreement Overview";
const heroParagraphs = ["We take pride in offering comprehensive rent agreements that establish clear and harmonious relationships between landlords and tenants. Our meticulous agreements are designed to ensure transparency, legal compliance, and a positive rental experience for all parties involved.",
];
const price = "STARTING FROM RS. 2499/-";
const cta = "KNOW ABOUT PACKAGE";

const definition = {
  title: "Key Features of Our Rent Agreements",
  paragraphs: [
    "01. Lease Terms: Clearly defined terms, including rent amount, payment due dates, and any specific conditions agreed upon by both parties.",
    "02. Legal Compliance: Rent agreements crafted to comply with local laws and regulations, providing a legally sound foundation for secure and lawful rentals.",
    "03. Property Maintenance: Well-defined responsibilities for property maintenance, ensuring a well-kept space throughout the lease period.",
    "04. Financial Transparency: Transparent information on security deposits, rent increments, and any other financial obligations, promoting a clear understanding of financial responsibilities.",
    "05. Renewal and Termination: Clear provisions for lease renewal and termination, providing a straightforward process for the end of the lease term or possible renewal.",
    "06. Utilities and Maintenance Fees: Details on how utilities will be handled and any maintenance fees applicable to the tenant.",
    "07. Security Deposit Terms: Specific terms regarding the security deposit, including the amount, conditions for its return, and any deductions that may apply.",
    "08. Entry and Inspection Protocols: Clearly outlined protocols for landlord entry and property inspections, respecting the tenant's privacy and providing ample notice.",
    "09. Subletting and Alterations: Clauses addressing subletting conditions and any alterations or modifications to the property by the tenant.",
    "10. Dispute Resolution: Provisions for dispute resolution, promoting open communication and providing mechanisms for conflict resolution."
  ],
};
const requirement  = [  
   {
    subtitle: "Proof of Identity",
    paragraphs: ["Landlord: Government-issued photo ID (passport, driver's license, etc.",
    "Tenant: Government-issued photo ID for all adults who will be residing on the property.",]
  },
   {
    subtitle: "Proof of Ownership",
    paragraphs: "Property ownership documents such as a title deed or property tax records."
  },
   {
    subtitle: "Address Proof",
    paragraphs: "Proof of the property address, which could include recent utility bills, property tax receipts, or any other relevant documents."
  },
   {
    subtitle: "Rental Application",
    paragraphs: "Completed rental application forms providing details about the tenant's rental history, employment, and references."
  },
  {
      subtitle: "Income Proof",
      paragraphs: ["Landlord: Proof of income or ownership of the property.",
        "Tenant: Proof of income or employment, such as pay stubs, employment letters, or tax returns.",]
    },
    {
     subtitle: "Security Deposit Receipt",
     paragraphs: "A document acknowledging the receipt of the security deposit, including the amount and terms for its return."
   },
    {
     subtitle: "List of Furnishings and Fixtures (if furnished)",
     paragraphs: "A detailed inventory of the furnishings and fixtures provided with the property, including their condition."
   },
    {
     subtitle: "Credit Check Authorization (if applicable)",
     paragraphs: "Written consent from the tenant allowing the landlord to conduct a credit check."
   },
    {
     subtitle: "Rent Agreement Form",
     paragraphs: "The actual rent agreement document outlining the terms and conditions of the lease, including details on rent, duration, and any specific clauses."
   },
    {
     subtitle: "Bank Statements (if required)",
     paragraphs: "Sometimes landlords may request bank statements to verify financial stability."
   },
    {
     subtitle: "Guarantor Agreement (if applicable)",
     paragraphs: "If a third party is guaranteeing the lease, a separate agreement may be required along with their proof of identity and income."
   },
    {
     subtitle: "Tenant’s Insurance Policy (if required)",
     paragraphs: "Proof of tenant's insurance coverage, if stipulated in the lease agreement."
   },
    {
     subtitle: "Non-Refundable Fees Receipt (if applicable)",
     paragraphs: "Receipts for any non-refundable fees charged, such as application fees or pet fees."
   },
...
const incorporationSupportSteps = [
  {
    ...
    description:
      "One of the person from our team will collect all the data for drafting of rent agreemnt. After reciveing data our expert will verify the same and they will update you time to time for the same.",
  },
  {
    title: "Drafting",
              ...
              >
               ...
               <div className="self-stretch">
                <div className="lg:sticky lg:top-36">
                  ...
                  <h2 className="text-3xl font-extrabold leading-tight text-slate-900 md:text-4xl">
                    Requirement for Rent Agreement
                  </h2>
                  <div className="mt-6 h-1 w-20 rounded-full bg-gradient-to-r from-[#a63f04] to-[#e65a05]" />                 
                </div>
              </div>
