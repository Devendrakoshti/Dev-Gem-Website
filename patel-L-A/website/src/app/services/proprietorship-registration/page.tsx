...
const metaTitle = "Proprietorship Registration | PATEL LEGAL ADVISORS";
const metaDescription =
  "A sole proprietorship, also known as a sole tradership, individual entrepreneurship or proprietorship, is a type of enterprise owned and run by one person and in which there is no legal distinction between the owner and the business entity. A sole trader does not necessarily work alone and may employ other people.";

const title = "Proprietorship";
const heroParagraphs = [
  "A sole proprietorship, also known as a sole tradership, individual entrepreneurship or proprietorship, is a type of enterprise owned and run by one person and in which there is no legal distinction between the owner and the business entity. A sole trader does not necessarily work alone and may employ other people.",
];
const price = "STARTING FROM RS. 999/-";
const cta = "KNOW ABOUT PACKAGE";

const definition = {
  title: "About Proprietorship",
  paragraphs: [
    "A sole proprietorship is a business that can be owned and controlled by an single person. There are no partners in the business. A sole proprietor is the beneficiary of all profits. All risks are to be borne by the proprietor. The proprietor has unconditional and full control over its business.",
  ],
};

const benefitsSection = {
  title: "Process of Proprietorship Registration",
  paragraphTitles: [
    "Select a Proprietorship Formation Package",
    "Add Company Address Services:",
    "Complete the Checklist Provided by Us",
    "Submit Your Online Application for Registration",
  ],
  paragraphs: [
    "We offer a wide selection of packages for Proprietorship Registration.",
    "Proprietor must provide details of a registered office for all business communication.",
    ...
    "We will check your Proprietor formation application before sending it for registration where it will be processed within approximately 1-2 working hours. You will be notified by email as soon as your Proprietor registration is approved.",
  ],
};
...
const pricing = [
  ...
  },
  {
    ...
    features: [
     "MSME Registration",
      "GST Registration",
      "GST Return for 3 month ( upto 50 entries)",
    ],
  },
];
