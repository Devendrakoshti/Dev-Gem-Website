...
const metaTitle = "Lease Agreement | PATEL LEGAL ADVISORS";
const metaDescription ="At PATEL LEGAL ADVISORS, we take pride in offering comprehensive lease agreements that foster clear and mutually beneficial relationships between landlords and tenants. Our lease agreements are meticulously crafted to ensure transparency, legal compliance, and a harmonious living or working arrangement for all parties involved.";

const title = "Lease Agreement Overview";
const heroParagraphs = [
  "At PATEL LEGAL ADVISORS, we take pride in offering comprehensive lease agreements that foster clear and mutually beneficial relationships between landlords and tenants. Our lease agreements are meticulously crafted to ensure transparency, legal compliance, and a harmonious living or working arrangement for all parties involved.",
];
const price = "STARTING FROM RS. 2999/-";
const cta = "KNOW ABOUT PACKAGE";

const definition = {
  title: "Key Features of Our Lease Agreements",
  paragraphs: [
    "01. Comprehensive Terms: Our lease agreements cover all essential terms, including the agreed-upon rent amount, lease duration, and any specific conditions or clauses mutually decided upon by the parties.",
    "02. Legal Compliance: Rest assured that our lease agreements comply with local laws and regulations, providing you with a legally sound foundation for your leasing arrangement.",
    "03. Maintenance Responsibilities: Clear and defined terms outlining maintenance responsibilities for both landlords and tenants. This ensures a well-maintained property throughout the lease term.",
    "04. Deposit and Fees: Transparent information regarding security deposits, fees, and any other financial obligations. This promotes a clear understanding of financial responsibilities for both parties.",
    "05. Renewal and Termination: Our lease agreements address renewal options and termination conditions, providing a roadmap for the end of the lease term or the possibility of renewal.",
  ],
};
const requirement  = [  
   {
  ...
  },
  {
    ...
    {
     subtitle: "Lease Agreement Form",
     paragraphs: "The actual lease agreement document outlining the terms and conditions of the lease, including details on rent, duration, and any specific clauses."
   },
    {
