...
const metaTitle = "LLP Incorporation | PATEL LEGAL ADVISORS";
...
const price = "STARTING FROM RS. 9999/-";
...
const benefitsSection = {
  title: "Process of Llp Incorporation",
  paragraphTitles: [
    "Choose A LLP Name",
    "Select a Llp Formation Package",
    "Add Llp Address Services",
    "Complete the Checklist Provided by Us",
    "Submit Your Online Application to Mca.",
  ],
  paragraphs: [
    "To find out the availability of your proposed name, simply enter it into our online LLP name-check tool. This system will compare any name you enter against the Index of LLP Names at MCA.",
    "We offer a wide selection of packages for Limited Liability Partnership.",
    "All Limited Liability Partnership must provide details of a registered office. A service address must also be supplied by each designated partner, partner, company secretary, and Person with Significant Control (PSC).",
    ...
    "We will check your LLP formation application before sending it to MCA, where it will be processed within approximately 3-6 working hours (weekends excluded). You will be notified by email as soon as your LLP registration is approved.",
  ],
};
...
const pricing = [
  {
    ...
    features: [
      ...
      "LLP Agreement (Stamping NotaryNot included)",
  ...
  },
  {
    ...
    features: [
      ...
      "E-TAN",
      "GST Registration",
      "Trademark Registration-1 Application",
    ],
  },
  {
    title: "Professional",
    ...
    features: [
      "3 DIN & 3 DSC",
      "1 Name Approval Letter",
      "LLP Agreement (Stamping Notary Not included)",
      "Certificate of Incorporation",
      "E-PAN",
      "E-TAN",
      "MSME Registration",
      "GST Registration",
      "Trademark Registration-1 Application",
      "ANNUAL FILING (1 lakh Contribution and 20 lac turnover and 100 entries)",
      "Filing Of FORM-11",
      "Filing Of FORM-8",
      "2 Director KYC",
      "ITR Filing For One Year (up to 20 lac turnover)",
      "GST Return Filing For 1 year (50 invoice per month)",
...
const incorporationSupportSteps = [
  {
    ...
    description:
      "One of the person from our team will collect all the imformation and documents for incorporate LLP. All documents should be signed. After reciveing documents our expert will verify the same and they will update you time to time for the same.",
  },
  {
    title: "Approval of Name",
    description:
      "Once the verification is complete our team will apply for name approval of LLP which name is given by you. After that they will apply for Digital Signature Certificate also.",
  },
  {
    title: "Certification",
    description:
      "Our team will file all the mandatory forms. Once Certificate of incoporation, PAN & TAN recived you can apply for your bank account open.        ",
  },
];
